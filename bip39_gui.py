...
class Ui_Bip39Tool(object):
    def setupUi(self, Bip39Tool):
        ...
        self.gridLayout.addWidget(self.numaddresses_label, 15, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.numaddress_spinbox, 16, 1, 1, 1)
        self.derivationpath_label = QtWidgets.QLabel(Bip39Tool)
        self.derivationpath_label.setObjectName("derivationpath_label")
        self.gridLayout.addWidget(self.derivationpath_label, 17, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.testnet_checkbox, 17, 5, 2, 1)
        ...
        self.gridLayout.addWidget(self.address_combobox, 18, 1, 2, 1)
        ...
        self.gridLayout.addWidget(self.derivationpath_box, 18, 2, 2, 3)
        ...
        self.gridLayout.addWidget(self.hardened_checkbox, 19, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.okbutton_box, 19, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.output_textbrowser, 20, 0, 1, 7)
        ...
        self.word21_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word21_box.setObjectName("word21_box")
        self.gridLayout.addWidget(self.word21_box, 9, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.numwords_combobox, 16, 5, 1, 2)
        self.numwords_label = QtWidgets.QLabel(Bip39Tool)
        self.numwords_label.setObjectName("numwords_label")
        self.gridLayout.addWidget(self.numwords_label, 15, 5, 1, 1)
        ...
        self.word11_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word11_box.setObjectName("word11_box")
        self.gridLayout.addWidget(self.word11_box, 11, 1, 1, 3)
        ...
        self.word18_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word18_box.setObjectName("word18_box")
        self.gridLayout.addWidget(self.word18_box, 6, 5, 1, 1)
        ...
        self.word17_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word17_box.setObjectName("word17_box")
        self.gridLayout.addWidget(self.word17_box, 5, 5, 1, 1)
        ...
        self.word1_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word1_box.setObjectName("word1_box")
        self.gridLayout.addWidget(self.word1_box, 1, 1, 1, 3)
        ...
        self.word14_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word14_box.setObjectName("word14_box")
        self.gridLayout.addWidget(self.word14_box, 2, 5, 1, 1)
        ...
        self.word20_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word20_box.setObjectName("word20_box")
        self.gridLayout.addWidget(self.word20_box, 8, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.bip39_checkbox, 13, 5, 1, 1)
        ...
        self.word4_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word4_box.setObjectName("word4_box")
        self.gridLayout.addWidget(self.word4_box, 4, 1, 1, 3)
        ...
        self.word9_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word9_box.setObjectName("word9_box")
        self.gridLayout.addWidget(self.word9_box, 9, 1, 1, 3)
        ...
        self.word8_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word8_box.setObjectName("word8_box")
        self.gridLayout.addWidget(self.word8_box, 8, 1, 1, 3)
        ...
        self.word12_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word12_box.setObjectName("word12_box")
        self.gridLayout.addWidget(self.word12_box, 12, 1, 1, 3)
        ...
        self.word19_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word19_box.setObjectName("word19_box")
        self.gridLayout.addWidget(self.word19_box, 7, 5, 1, 1)
        ...
        self.word15_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word15_box.setObjectName("word15_box")
        self.gridLayout.addWidget(self.word15_box, 3, 5, 1, 1)
        ...
        self.word22_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word22_box.setObjectName("word22_box")
        self.gridLayout.addWidget(self.word22_box, 10, 5, 1, 1)
        ...
        self.word23_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word23_box.setObjectName("word23_box")
        self.gridLayout.addWidget(self.word23_box, 11, 5, 1, 1)
        ...
        self.word24_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word24_box.setObjectName("word24_box")
        self.gridLayout.addWidget(self.word24_box, 12, 5, 1, 1)
        ...
        self.word16_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word16_box.setObjectName("word16_box")
        self.gridLayout.addWidget(self.word16_box, 4, 5, 1, 1)
        ...
        self.word10_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word10_box.setObjectName("word10_box")
        self.gridLayout.addWidget(self.word10_box, 10, 1, 1, 3)
        ...
        self.word7_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word7_box.setObjectName("word7_box")
        self.gridLayout.addWidget(self.word7_box, 7, 1, 1, 3)
        ...
        self.word2_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word2_box.setObjectName("word2_box")
        self.gridLayout.addWidget(self.word2_box, 2, 1, 1, 3)
        ...
        self.word3_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word3_box.setObjectName("word3_box")
        self.gridLayout.addWidget(self.word3_box, 3, 1, 1, 3)
        ...
        self.word5_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word5_box.setObjectName("word5_box")
        self.gridLayout.addWidget(self.word5_box, 5, 1, 1, 3)
        ...
        self.word13_box.setMaximumSize(QtCore.QSize(161, 16777215))
        self.word13_box.setObjectName("word13_box")
        self.gridLayout.addWidget(self.word13_box, 1, 5, 1, 1)
        ...
        self.word6_box.setMaximumSize(QtCore.QSize(1678000, 16777215))
        self.word6_box.setObjectName("word6_box")
        self.gridLayout.addWidget(self.word6_box, 6, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.title_label, 0, 3, 1, 3)
        self.textfile_CheckBox = QtWidgets.QCheckBox(Bip39Tool)
        self.textfile_CheckBox.setObjectName("checkBox")
        self.gridLayout.addWidget(self.textfile_CheckBox, 17, 6, 1, 1)
        ...
        Bip39Tool.setTabOrder(self.numaddress_spinbox, self.numwords_combobox)
        Bip39Tool.setTabOrder(self.numwords_combobox, self.address_combobox)
        ...
        Bip39Tool.setTabOrder(self.hardened_checkbox, self.textfile_CheckBox)
    ...
    def retranslateUi(self, Bip39Tool):
        ...
        self.address_combobox.setItemText(4, _translate("Bip39Tool", "BIP32"))
